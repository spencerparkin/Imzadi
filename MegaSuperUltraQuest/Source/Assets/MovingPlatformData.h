 ...
 */
class MovingPlatformData : public Asset
{
...
public:
	...
	const std::vector<Collision::Vector3>& GetSplineDeltaArray() const { return this->splineDeltas; }
...
private:
	...
	std::vector<Collision::Vector3> splineDeltas;
