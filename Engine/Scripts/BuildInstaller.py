...
if __name__ == '__main__':
    ...
    with open(mapping_file, 'w') as map_file_handle:
        ...
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Animations'), ('Games\\%s\\Assets\\Animations' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Audio'), ('Games\\%s\\Assets\\Audio' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Dialog'), ('Games\\%s\\Assets\\Dialog' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Icons'), ('Games\\%s\\Assets\\Icons' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Levels'), ('Games\\%s\\Assets\\Levels' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Models'), ('Games\\%s\\Assets\\Models' % args.game))
        dump_file_maps(map_file_handle, os.path.join(game_folder, 'Assets\\Textures'), ('Games\\%s\\Assets\\Textures' % args.game))
